...
-- Criar guia com tudo junto
local SectionTab = MainFrame:CreateTab({ Name = "Aimbot" })
local Section = SectionTab:CreateSection({ Name = "Configurações" })
...
-- Texto de crédito
Section:AddLabel("Created By Pedrin031")
